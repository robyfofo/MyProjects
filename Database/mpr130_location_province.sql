...
--
-- Host: localhost:3306
-- Creato il: Set 21, 2020 alle 16:19
...
--
-- Struttura della tabella `mpr130_location_province`
--

CREATE TABLE `mpr130_location_province` (
...
--
-- Dump dei dati per la tabella `mpr130_location_province`
--

INSERT INTO `mpr130_location_province` (`id`, `nome`, `targa`, `active`) VALUES
(1, 'Torino', 'TO', NULL),
(2, 'Vercelli', 'VC', NULL),
(3, 'Novara', 'NO', NULL),
(4, 'Cuneo', 'CN', NULL),
...
--
-- Indici per le tabelle `mpr130_location_province`
--
ALTER TABLE `mpr130_location_province`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT per la tabella `mpr130_location_province`
--
ALTER TABLE `mpr130_location_province`
