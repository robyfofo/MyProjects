...
--
-- Struttura della tabella `mpr130_estimates`
--

CREATE TABLE `mpr130_estimates` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `mpr130_estimates`
--
ALTER TABLE `mpr130_estimates`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `mpr130_estimates`
--
ALTER TABLE `mpr130_estimates`
