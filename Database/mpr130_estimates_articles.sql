...
--
-- Host: localhost:3306
-- Creato il: Set 18, 2020 alle 08:55
...
--
-- Struttura della tabella `mpr130_estimates_articles`
--

CREATE TABLE `mpr130_estimates_articles` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `mpr130_estimates_articles`
--
ALTER TABLE `mpr130_estimates_articles`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT per la tabella `mpr130_estimates_articles`
--
ALTER TABLE `mpr130_estimates_articles`
