...
--
-- Struttura della tabella `mpr130_thirdparty`
--

CREATE TABLE `mpr130_thirdparty` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `mpr130_thirdparty`
--
ALTER TABLE `mpr130_thirdparty`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `mpr130_thirdparty`
--
ALTER TABLE `mpr130_thirdparty`
