<!-- admin/site-galleries/listCate.tpl.php v.3.0.0. 03/11/2016 -->
<div class="row">
	<div class="col-md-3 new">
		<a href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/newCate" title="Inserisci un nuov<?php echo $this->App->params->labels['cate']['itemSex']; ?> <?php echo $this->App->params->labels['cate']['item']; ?>" class="btn btn-primary">Nuov<?php echo $this->App->params->labels['cate']['itemSex']; ?> <?php echo $this->App->params->labels['cate']['item']; ?></a>
	</div>
							...
							<?php if (is_array($this->App->items) && count($this->App->items) > 0): ?>
								<?php foreach ($this->App->items AS $key => $value): ?>
									<tr>										
										...
										<td><a href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/listItem/<?php echo $value->id; ?>" title="Vai al contenuto della cartella"><i class="fa fa-picture-o fa-fw"></i> - <?php echo $value->numitems; ?></a></td>								
										<td class="actions">
