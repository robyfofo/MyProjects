 ...
 * admin/site-galleries/config.inc.php v.3.0.0. 03/11/2016
*/

$App->params = new stdClass();

/* prende i dati del modulo */
Sql::initQuery(DB_TABLE_PREFIX.'site_modules',array('help_small','help'),array('site-galleries'),'name = ?');
$obj = Sql::getRecord();
...
$App->params->uploadPaths['item'] = PATH_UPLOAD_DIR."site-media/galleries/";
$App->params->uploadDirs['item'] = UPLOAD_DIR."site-media/galleries/";
$App->params->tables['item'] = DB_TABLE_PREFIX.'site_galleries';
...
/* CATE */
$App->params->labels['cate'] = array('item'=>'galleria','itemSex'=>'a','items'=>'gallerie','itemsSex'=>'e','son'=>$App->params->labels['item']['item'],'sonSex'=>$App->params->labels['item']['itemSex'],'sons'=>$App->params->labels['item']['items'],'sonsSex'=>$App->params->labels['item']['itemsSex'],'owner'=>'','ownerSex'=>'','owners'=>'','ownersSex'=>'');
$App->params->ordersType['cate'] = 'DESC';
$App->params->tables['cate'] = DB_TABLE_PREFIX.'site_galleries_cat';
