<!-- siteimages/listFolders.tpl.php v.3.0.0. 02/11/2016 -->
<div class="row">
							...
							<?php if (is_array($this->App->items) && count($this->App->items) > 0): ?>
								<?php foreach ($this->App->items AS $key => $value): ?>
									<tr>										
										...
										<td><a href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/listItem/<?php echo $value->id; ?>" title="Vai al contenuto della cartella"><i class="fa fa-picture-o fa-fw"></i> - <?php echo $value->numimages; ?></a></td>								
										<td class="actions">
