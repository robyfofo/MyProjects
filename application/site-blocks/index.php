 ...
 * admin/site-blocks/index.php v.3.0.0. 03/11/2016
*/
...
$App->params->labels = $App->params->labels;

$App->params->tables['item'] = $App->params->tables['item'];
$App->params->fields['item'] = $App->params->fields['item'];
