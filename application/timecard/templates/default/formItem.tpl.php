...
<div class="row">
	<div class="col-md-6">
		...
		<form id="applicationForm" class="form-horizontal form-daydata bg-info" role="form" action="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/modappproject"  enctype="multipart/form-data" method="post">
			<div class="form-group">
				<div class="col-md-10">		
									...
									<tbody>
										<?php foreach ($this->App->timecards[$day['value']]['timecards'] AS $value): ?>
											<tr>
												...
												<td class="text-right" style="width:35px;"><a onclick="bootbox.confirm();" class="btn btn-default btn-circle btn-circle-timecard confirm" href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/deleteTime/<?php echo $value->id; ?>" title="Cancella">X</a></td>
											</tr>
										<?php endforeach; ?>										
										<tr>
											<td colspan="1">&nbsp;</td>
	...
	<div class="col-md-6">	
		<form id="applicationForm" method="post" class="form-horizontal bg-info form-timecard" role="form" action="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/addtime"  enctype="multipart/form-data" method="post">
			<fieldset>
				<div class="form-group">
