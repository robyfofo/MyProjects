...
<div class="row">
	<div class="col-md-3 new">
  		<a href="<?php echo URL_SITE_ADMIN; ?><?php echo Core::$request->action; ?>/new" title="Inserisci nuov<?php echo $this->App->params->labels['itemSex']; ?> <?php echo $this->App->params->labels['item']; ?>" class="btn btn-primary">Nuov<?php echo $this->App->params->labels['itemSex']; ?> <?php echo $this->App->params->labels['item']; ?></a>
	</div>
							...
							<?php if (is_array($this->App->items) && count($this->App->items) > 0): ?>
								<?php foreach ($this->App->items AS $key => $value): ?>
									<tr>
										...
										<td><?php echo SanitizeStrings::htmlout($value->modules); ?></td>																								
										<td class="actions">
