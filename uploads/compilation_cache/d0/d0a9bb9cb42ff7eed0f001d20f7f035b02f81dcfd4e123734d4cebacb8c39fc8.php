...
class __TwigTemplate_70e7a1b4f210f3d986340eca29040b24491e3362479c5822d8b4bcf5637c14aa extends Twig_Template
{
    ...
    {
        // line 1
        echo "<!-- admin/timecard/formItem.tpl.php v.1.0.0. 02/03/2017 -->
...
\t\t\t\t\t\t\t\t<option value=\"";
                ...
                echo "\"";
                if ((twig_get_attribute($this->env, $this->getSourceContext(), $context["value"], "id", array()) == twig_get_attribute($this->env, $this->getSourceContext(), twig_get_attribute($this->env, $this->getSourceContext(), ($context["App"] ?? null), "currentProject", array()), "id", array()))) {
                    echo " selected=\"selected\" ";
                }
                echo ">";
...
\t</div>
    ...
    {
        return new Twig_Source("<!-- admin/timecard/formItem.tpl.php v.1.0.0. 02/03/2017 -->
