...
/* site-home/templates/default/list.tpl.php */
class __TwigTemplate_678232aea53c253fc6502e7b736631ba1f86e2220de1f4e4255b27ef91668d4e extends Twig_Template
{
...
\t\t<h5>";
        // line 5
        echo twig_capitalize_string_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), twig_get_attribute($this->env, $this->getSourceContext(), ($context["App"] ?? null), "lang", array()), "ultimo accesso", array(), "array"));
        echo ": ";
...
\t\t\t\t\t\t\t\t<span class=\"pull-left\">";
                    // line 34
                    echo twig_title_string_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), twig_get_attribute($this->env, $this->getSourceContext(), ($context["App"] ?? null), "lang", array()), "vedi dettagli", array(), "array"));
                    echo "</span>
...
\t\t\t";
    ...
    {
        return "site-home/templates/default/list.tpl.php";
    }
...
\t\t{% endfor %}
\t{% endif %}
</div>", "site-home/templates/default/list.tpl.php", "/var/www/html/myprojects/application/site-home/templates/default/list.tpl.php");
    }
}
